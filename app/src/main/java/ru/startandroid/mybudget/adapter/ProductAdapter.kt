package ru.startandroid.mybudget.adapter
...
class ProductAdapter(private val mList: List<Product>) : RecyclerView.Adapter<ProductAdapter.ViewHolder>() {
    ...
    class ViewHolder(ItemView: View) : RecyclerView.ViewHolder(ItemView) {
        val tvName: TextView = itemView.findViewById(R.id.itemTvName)
        val tvPrice: TextView = itemView.findViewById(R.id.itemTvPrice)
    }
}
